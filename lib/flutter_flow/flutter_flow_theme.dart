...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFE90A4D);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xBA000000);
  late Color alternate = const Color(0xFFF0F2F6);
  late Color primaryText = const Color(0xFFE90A4D);
  late Color secondaryText = const Color(0xBA000000);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF0F2F6);
  ...
  late Color vibrantColor = const Color(0xFFE80848);
  late Color lightVibrantColor = const Color(0xFFE7648F);
  late Color mutedColor = const Color(0xFF85858A);
  late Color lightMutedColor = const Color(0xFFE8F0F0);
  late Color darkMutedColor = const Color(0xFF434343);
  late Color darkVibrantColor = const Color(0xFFB01946);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFE90A4D);
  late Color secondary = const Color(0xFFF0F2F6);
