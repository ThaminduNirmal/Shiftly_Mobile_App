// Firebase auth removed; using backend auth
...
class _LoginWidgetState extends State<LoginWidget> {
            ...
            Align(
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    Align(
                      alignment: const AlignmentDirectional(0.06, -8.0),
                      child: Container(
                        width: 334.6,
                        height: 390.0,
                        decoration: BoxDecoration(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          if (_model.validation!) {
                                             // Call backend auth
                                             final success = await _loginWithBackend(
  ...
  Future<bool> _loginWithBackend({required String username, required String password}) async {
