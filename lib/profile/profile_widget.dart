                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: _localPhoto != null
                                  ...
                                  : Image.network(
                                      'https://images.unsplash.com/photo-1592520113018-180c8bc831c9?auto=format&fit=crop&w=200&q=60',
                                      width: 100.0,
                                      height: 100.0,
                                      fit: BoxFit.cover,
                                    ),
                        ...
                        FutureBuilder<Map<String, dynamic>?>(
                          future: EmployeeService().fetchMyEmployeeProfile(),
                          builder: (context, snapshot) {
                            final name = snapshot.data?['fullName'] ?? snapshot.data?['firstName'] ?? 'User';
                            return Text(
                              name,
                        ...
                        Padding(
                          ...
                          child: FutureBuilder<Map<String, dynamic>?>(
                            future: EmployeeService().fetchMyEmployeeProfile(),
                            builder: (context, snapshot) {
                              final email = snapshot.data?['reportingPersonEmail'] ?? '';
                              return Text(
                                email,
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
